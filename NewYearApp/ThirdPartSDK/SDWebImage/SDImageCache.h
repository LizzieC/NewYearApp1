...
/**
 * Sets the global maximum cache count
 *
 * @param maxCount The maximum count to keep images in the cache
 */
...
/**
 * Remove beyond count image from disk
 */
