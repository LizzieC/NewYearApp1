...
NSString *pathForURL(NSURL *aURL){
    return pathInCacheDirectory([NSString stringWithFormat:@"com.xmly/cachedImage-%lu", (unsigned long)[[aURL description] hash]]);
}
...
{
    return [NSString stringWithFormat:@"%lu",(unsigned long)[[aURL description]hash]];
}
