...
//    CGContextSetShadowWithColor(context, CGSizeMake(0, -1), 1, [[UIColor whiteColor] CGColor]);// 设置字体阴影
    ...
    [info_ drawInRect:r withFont:[UIFont systemFontOfSize:kHUDFontSize] lineBreakMode:NSLineBreakByTruncatingTail];
}
...
+ (void)showInView:(UIView *)view info:(NSString *)str isCenter:(BOOL)flag
{
    ...
    alert.center = CGPointMake(view.center.x, flag == YES ? (view.center.y - 100) : view.frame.size.height - 80);
    alert.alpha = 0;
    ...
    [alert performSelector:@selector(fadeAway) withObject:nil afterDelay:3];
}
